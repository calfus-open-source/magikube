...
export default class EKSVPCTemplateProject extends AWSProject {
  ...
  async createMainFile(): Promise<void> {
    ...
    this.createFile( "terraform.tfvars", "../templates/aws/eks-fargate/terraform.tfvars.liquid" ,"/infrastructure");
    this.createFile("variables.tf","../templates/aws/eks-fargate/variables.tf.liquid" , "/infrastructure");
