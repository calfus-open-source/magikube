...
export default class AzureAKSProject
  extends AzureProject
  implements CloudProject
{
  ...
  async createMainFile(): Promise<void> {
    ...
    const argocdInstance = new argoCdProjectAzure(
      command as BaseCommand,
      this.config,
    );
    ...
    this.createFile(
      'main.tf',
      `${path}/dist/templates/azure/environments/dev/main.tf.liquid`,
      `/infrastructure`,
      true,
    );
    this.createFile(
      'terraform.tfvars',
      `${path}/dist/templates/azure/environments/dev/terraform.tfvars.liquid`,
      `/infrastructure`,
      true,
    );
    this.createFile(
      'variables.tf',
      `${path}/dist/templates/azure/environments/dev/variables.tf.liquid`,
      '/infrastructure',
      true,
    );
    this.createFile(
      'outputs.tf',
      `${path}/dist/templates/azure/environments/dev/outputs.tf.liquid`,
      '/infrastructure',
      true,
    );
    this.createFile(
