...
//         // Paths
//         const k8sConfigPath = join(this.projectPath, 'infrastructure', 'k8s_config');
//         const envConfigPath = join(this.projectPath, 'infrastructure', `${this.config.environment}-config.tfvars`);
//         const tfvarsPath = join(this.projectPath, 'infrastructure', 'terraform.tfvars');

//         // Check if it has multiple modules
//         if (this.config.cluster_type === 'k8s') {
//             // Initialize the terraform
//             console.log(this.projectPath, "project-path");
//             await terraform?.runTerraformInit(k8sConfigPath, envConfigPath);
//             terraform?.startSSHProcess();

//             // Destroy the ingress and other helm modules
//             await terraform?.runTerraformDestroy(k8sConfigPath, 'module.ingress-controller', tfvarsPath);
//             terraform?.stopSSHProcess();
//         }
        
//         // Destroy the whole project
//         await terraform?.runTerraformDestroy(join(this.projectPath, 'infrastructure'));
//     }
