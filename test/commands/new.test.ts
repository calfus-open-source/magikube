...
describe('CreateProject Command', () => {
  ...
  describe('Template Support', () => {
    ...
    test('should have predefined templates', () => {
      const {
        supportedTemplates,
      } = require('../../src/core/constants/constants.js');
  ...
  describe('Terraform Project Management', () => {
    ...
    test('should create project with terraform', async () => {
      ...
      expect(terraform.createProject).toHaveBeenCalledWith(
        'myapp',
        '/path',
        'new',
      );
  ...
  describe('Service Health Checks', () => {
    test('should check service health status', async () => {
      const {
        serviceHealthCheck,
      } = require('../../src/core/utils/healthCheck-utils.js');
  ...
  describe('Utility Functions', () => {
    ...
    test('should handle template flag', async () => {
      const {
        handleTemplateFlag,
      } = require('../../src/core/utils/groupingTemplateProject-utils.js');
    ...
    test('should handle EKS infrastructure', async () => {
      const {
        handleEKSandAKS,
      } = require('../../src/core/utils/terraformHandlers-utils.js');
    ...
    test('should setup and push services', async () => {
      const {
        setupAndPushServices,
      } = require('../../src/core/utils/setupAndPushService-utils.js');
    ...
    test('should copy and clone templates', async () => {
      const {
        cloneAndCopyTemplates,
      } = require('../../src/core/utils/copyTemplates-utils.js');
  ...
  describe('Status File Management', () => {
    test('should initialize status file', () => {
      ...
      expect(initializeStatusFile).toHaveBeenCalledWith(
        'myapp',
        ['vpc'],
        ['auth-service'],
      );
  ...
  describe('Application Setup', () => {
    test('should setup gitops service', async () => {
      const CreateApplication =
        require('../../src/core/setup-application.js').default;
